...
public class IndexController {
    ...
    public IndexController(ProductoService productoService, CategoriaService categoriaService, MessageSource messageSource) {
    ...
    public String listado(@PathVariable ("idCategoria")Integer idCategoria, Model model){
        ...
        if (categoriaOpt.isEmpty()){//Si no se encontro la categoria
